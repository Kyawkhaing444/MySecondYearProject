...
<section id="main-content">
 ...
 <h1><i class="icon_document_alt"></i>  Manage Post</h1>
  <div>
     <?php echo Message();
	         echo SuccessMessage();
     ?>
  ...
  <?php
	...
	<tr>
        ...
        <?php
	        if(strlen($Name)>19){$Name=substr($Name,0,19).'..';}
	        echo $Name;
	      ?></td>
	    <td>
        <?php
	...
	<td>
	    ...
	    <td>
          <img src="../../Fornt_end/Home/Upload/<?php echo $Image; ?>" width="170px"; height="50px">
      </td>
	    <td>
      <?php
      $ConnectingDB;
      $Connection;
      $QueryApproved="SELECT COUNT(*) FROM Comments_POST WHERE Post_id='$Id' AND status='ON'";
     ...
     $ConnectingDB;
     $Connection;
          $QueryUnApproved="SELECT COUNT(*) FROM Comments_POST WHERE Post_id='$Id' AND status='OFF'";
	...
	<td>
	      <a href="DeletePost1.php?Delete=<?php echo $Id; ?>">
	      <span class="btn btn-danger">Delete</span>
	      </a>
	    </td>
	    <td>
	      <a href="../../Fornt_end/Home/FullPost.php?id=<?php echo $Id; ?>">
