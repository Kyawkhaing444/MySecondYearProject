...
if(empty($Title)){
  ...
  $Admin = $_SESSION["UsernameAdmin"];
	$Query="UPDATE AdminBlog SET datetime='$DateTime', title='$Title',
...
<section id="main-content">
  <section class="wrapper">
	<div class = "row">
	   <div class="col-lg-12">
            <h1><i class="icon_document_alt"></i> Update post</h1>
            <div class="col-sm-10">
	           <?php echo Message();
	            echo SuccessMessage();
	           ?>
  ...
  <?php
    ...
    $ConnectingDB;
    $Connection;
	$Query="SELECT * FROM AdminBlog WHERE id='$SerachQueryParameter'";
