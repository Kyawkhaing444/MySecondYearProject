...
if(empty($Category)){
  ...
  global $ConnectingDB;
  global $Connection;
  $Query="INSERT INTO `category`(`Cat_id`, `datetime`, `name`, `creatername`) VALUES ('','$DateTime','$Category','$Admin')";
...
<body>
  ...
  <section id="main-content">
     ...
     <div class="row">
            <div class="col-lg-12">
              <h1><i class="icon_document_alt"></i> Categories</h1>
              <div class="col-sm-10">
	           <?php echo Message();
	            echo SuccessMessage();
	           ?>
...
<form action="Categories.php" method="post">
	...
	<label for="categoryname"><span class="FieldInfo"><br>Name:</span></label>
