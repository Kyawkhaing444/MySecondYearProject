...
global $Connection;
 if(isset($_POST["Submit"])){
     ...
     $Query = "SELECT * FROM Finished_Auction WHERE code='$code'";
     $Execute = mysqli_query($Connection,$Query);
     $Result = mysqli_fetch_assoc($Execute);
     if($Result != true){
        $_SESSION["ErrorMessage"] = "ကုတ္နံပါတ္မွားယြင္းေနပါသည္ ။ မိတ္ေဆြ အီးေမးသို့ ေလလံပြဲအတည္ေျကာင္းနွင့္တကြ ပို့လာေသာ ကုတ္ကို ရုိက္ထည့္ပါ။";
