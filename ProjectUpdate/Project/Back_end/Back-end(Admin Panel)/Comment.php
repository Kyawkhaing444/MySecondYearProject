...
<section id="main-content">
 ...
 <h1 style="color:green;"><i class="icon_documents_alt"></i> Blog Comments</h2>
 <br>
 <h2>Un-Approved Comments</h2>	
  ...
  <?php
    ...
    while($DataRows=mysqli_fetch_array($Execute)){
	    ...
	    $CommentedPostId=$DataRows['AdminBlog_id'];
        $SrNo++;
  ...
  <tr>
	...
	<td><a href="../../Fornt_end/Home/FullBlog.php?id=<?php echo $CommentedPostId; ?>">
...
<h2>Approved Comments</h2>	
  ...
  <td><?php echo htmlentities($Admin); ?></td>
	...
	<span class="btn btn-warning">Un-Approve</span></a></td>
	<td><a href="DeleteComments.php?id=<?php echo $CommentId;?>">
	<span class="btn btn-danger">Delete</span></a></td>
	<td><a href="../../Fornt_end/Home/FullBlog.php?id=<?php echo $CommentedPostId; ?>">
	<span class="btn btn-primary">Live Preview</span></a></td>
...
<!-- end Blog Comments -->
<br><hr>
<h1 style="color:green;"><i class="icon_documents_alt"></i> Post Comments</h2>
 <br>
 <h2>Un-Approved Comments</h2>	
  <div class="table-responsive">
	   <table class="table table-striped table-hover">
  ...
  <?php
    $ConnectingDB;
    $Connection;
    $ViewQuery="SELECT * FROM Comments_POST WHERE status='OFF' ORDER BY id desc";
    $Execute=mysqli_query($Connection,$ViewQuery);
    $SrNo=0;
    while($DataRows=mysqli_fetch_array($Execute)){
	    $CommentId=$DataRows['id'];
  ...
  <tr>
	...
	<td><?php echo htmlentities($DateTimeofComment); ?></td>
	<td><?php echo htmlentities($PersonComment); ?></td>
	<td><a href="ApproveCommentsP.php?id=<?php echo $CommentId; ?>">
	<span class="btn btn-success">Approve</span></a></td>
	<td><a href="DeleteCommentsP.php?id=<?php echo $CommentId;?>">
	<span class="btn btn-danger">Delete</span></a></td>
	<td><a href="../../Fornt_end/Home/FullPost.php?id=<?php echo $CommentedPostId; ?>">
	<span class="btn btn-primary">Live Preview</span></a></td>
  </tr>
<?php } ?>
</table>
...
<h2>Approved Comments</h2>	
  ...
  <?php
    ...
    $Connection;
    $Admin = "Kyaw Kyaw Khaing";
    $ViewQuery="SELECT * FROM Comments_POST WHERE status='ON' ORDER BY id desc";
    $Execute=mysqli_query($Connection,$ViewQuery);
    $SrNo=0;
    while($DataRows=mysqli_fetch_array($Execute)){
	    $CommentId=$DataRows['id'];
  ...
  <tr>
	...
	<td><?php echo htmlentities($PersonComment); ?></td>
  <td><?php echo htmlentities($Admin); ?></td>
	<td><a href="DisApproveCommentsP.php?id=<?php echo $CommentId; ?>">
	<span class="btn btn-warning">Un-Approve</span></a></td>
	<td><a href="DeleteCommentsP.php?id=<?php echo $CommentId;?>">
	<span class="btn btn-danger">Delete</span></a></td>
	<td><a href="../../Fornt_end/Home/FullPost.php?id=<?php echo $CommentedPostId; ?>">
